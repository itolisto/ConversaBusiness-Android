...
public class MaterialCamera {
    ...
    public static final String SIZE_EXTRA = "mcam_size";
    ...
    private boolean mSaveOnStillshot = false;
    private boolean mSaveOnCapture = false;
    private boolean mCompressData = true;
    ...
    private int mQualityProfile = QUALITY_LOW; //-1
    ...
    public MaterialCamera saveOnStillShot(boolean save) {
        mSaveOnStillshot = save;
        return this;
    }

    public MaterialCamera saveOnCapture(boolean save) {
        mSaveOnCapture = save;
        return this;
    }

    public MaterialCamera compressData(boolean compress) {
        mCompressData = compress;
        return this;
    }
    ...
    public Intent getIntent() {
        ...
        Intent intent = new Intent(mContext, cls)
                ...
                .putExtra(CameraIntentKey.SAVE_ON_CAPTURE, mSaveOnCapture)
                .putExtra(CameraIntentKey.SAVE_ON_STILLSHOT, mSaveOnStillshot)
                .putExtra(CameraIntentKey.COMPRESS_DATA, mCompressData);
