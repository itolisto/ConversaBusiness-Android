...
public class Camera2Fragment extends BaseCameraFragment implements View.OnClickListener {
    ...
    public void openCamera() {
        ...
        try {
            ...
            Log.e("Camera2Fragment", String.format("Orientations: Sensor = %d˚, Device = %d˚, Display = %d˚",
                ...
                mImageReader.setOnImageAvailableListener(
                        new ImageReader.OnImageAvailableListener() {
                            ...
                            public void onImageAvailable(ImageReader reader) {
                                ...
                                Image image = reader.acquireLatestImage(); // <-- This line was added -->
                                ByteBuffer buffer = image.getPlanes()[0].getBuffer();
                                final byte[] bytes = new byte[buffer.remaining()];
                                buffer.get(bytes);
                                image.close(); // <--- This line was added
...
//                                    }
//                                }
//                                Log.e("stillshot2", "picture saved to disk - jpeg, size: " + bytes.length);
//                                mOutputUri = outputPic.getPath();
//                                mInterface.onShowStillshot(mOutputUri);
                                // <-- This block was added -->
                                // Save the image to disk
                                if (mInterface.compressData()) {
                                    ImageUtil.saveToDiskWithCompressionAsync(bytes, outputPic,
                                            new ICompressCallback() {
                                        @Override
                                        public void done(Exception e, long newSize) {
                                            if (e == null) {
                                                Log.e("stillshot2", "picture compress saved to disk " +
                                                        "- jpeg, original size: " + bytes.length
                                                        + ", new size: " + newSize);
                                                mOutputUri = outputPic.getPath();
                                                ...
                                                Log.e("stillshot2", e.getMessage());
                                                throwError(e);
                                            }
                                        }
                                    });
                                } else {
                                    ImageUtil.saveToDiskAsync(bytes, outputPic, new ICallback() {
                                        @Override
                                        public void done(Exception e) {
                                            if (e == null) {
                                                Log.e("stillshot2", "picture saved to disk - jpeg, size: " + bytes.length);
                                                mOutputUri = outputPic.getPath();
                                                mInterface.onShowStillshot(mOutputUri, bytes.length);
                                                //mCamera.startPreview();
                                                mButtonStillshot.setEnabled(true);
                                            } else {
                                                Log.e("stillshot2", e.getMessage());
    ...
    private void runPrecaptureSequence() {
        try {
            ...
            Log.e("runPrecaptureSequence", e.getMessage());
        }
    }
        ...
        try {
            ...
            CameraCaptureSession.CaptureCallback CaptureCallback
                ...
                public void onCaptureCompleted(@NonNull CameraCaptureSession session,
                                               @NonNull CaptureRequest request,
                                               @NonNull TotalCaptureResult result) {
                    Log.e("stillshot", "onCaptureCompleted");
                    unlockFocus();
                }
            };
            ...
            Log.e("captureStillPicture", e.getMessage());
        }
    }
    ...
    public static class ErrorDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new MaterialDialog.Builder(activity)
                    .content(R.string.mcam_camera_api2_error)
