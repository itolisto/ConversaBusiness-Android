...
abstract class BaseCameraFragment extends Fragment implements CameraUriInterface, View.OnClickListener {
    ...
    public static final int GALLERY_IMAGE_REQUEST_CODE = 2001;

    protected static void LOG(Object context, String message) {
        Log.e(context instanceof Class<?> ? ((Class<?>) context).getSimpleName() :
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mButtonGallery = (ImageButton) view.findViewById(R.id.gallery);
        mButtonFacing = (ImageButton) view.findViewById(R.id.facing);

        if (CameraUtil.isChromium())
            mButtonFacing.setVisibility(View.GONE);
        else if (!CameraUtil.hasFrontCamera(getActivity()))
            mButtonFacing.setVisibility(View.GONE);
        ...
        if (mInterface.useStillshot()) {
            ...
            setImageRes(mButtonGallery, mInterface.iconGallery());
    ...
    public void onPause() {
        ...
        try {
            ...
            Log.e("onPause", "BaseCameraFragment: " + e.getMessage());
        }
        super.onPause();
    }
...
//                Log.e("0 landscape", "0 landscape");
//                break;
//            case Surface.ROTATION_90: // Landscape right
//                Log.e("90 portrait", "90 portrait");
//                break;
//            case Surface.ROTATION_180: // Landscape left
//                Log.e("180 landscape", "180 landscape");
//                break;
//            default:
//                Log.e("270 portrait", "270 portrait");
//                break;
//        }
//
...
//    }
    ...
    protected void onCameraOpened() {
        ...
        mDidAutoRecord = true;
        mButtonFacing.setVisibility(View.GONE);
        // If recording should start immediately
        ...
        // If not we create a Handler that will make the delay
