...
import ee.app.conversabusiness.messaging.CustomMessageService;
...
public class AblyConnection implements Channel.MessageListener, Presence.PresenceListener,
    ...
    public void subscribeToChannels() {
        String channelname = ConversaApp.getInstance(context).getPreferences().getBusinessId();
    ...
    public void userHasStartedTyping(String channelName) {
        ...
        try {
            ...
            payload.addProperty("from", ConversaApp.getInstance(context).getPreferences().getBusinessId());
