...
public class StillshotPreviewFragment extends BaseGalleryFragment implements CompleteCallback {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        FrameLayout container = (FrameLayout) view.findViewById(R.id.flStillshot);
    ...
    public void onDestroyView() {
        ...
        if (mBitmap != null && !mBitmap.isRecycled()) {
            try {
                ...
                t.printStackTrace();
                Log.e("onDestroyView", t.getMessage());
            }
        }
    }
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.retry)
            ...
            mInterface.useMedia(mOutputUri, sizeInBytes);
    }
}