...
public interface BaseCaptureInterface {
    ...
    void onShowStillshot(String outputUri, long sizeInBytes);
    ...
    void useMedia(String uri, long sizeInBytes);
    ...
    boolean saveOnCapture();

    boolean saveOnStillshot();

    boolean compressData();

    long getVideoSize(String outputUri);
}
