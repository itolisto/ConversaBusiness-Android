...
public class FirebaseCustomException extends Exception {
     ...
     */
    public FirebaseCustomException(int theCode, String theMessage) {
        super(theMessage);
        code = theCode;
    }
     ...
     */
    public FirebaseCustomException(int theCode, String message, Throwable cause) {
        super(message, cause);
        code = theCode;
    }
     ...
     *          The cause of the error.
     */
    public FirebaseCustomException(Throwable cause) {
        super(cause);
        code = OTHER_CAUSE;
    }
